            ...
            <div class="col-md-10">
                <div class="card shadow-sm">
                    ...
                    <div class="card-header bg-success text-white">
                        <h4 class="mb-0">Registrar Nuevo Entrenamiento</h4>
                    </div>
                        ...
                        <form method="POST" action="{{ route('resultados.store') }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <select id="id_bicicleta" name="id_bicicleta" class="form-control @error('id_bicicleta') is-invalid @enderror" required>
                                        <option value="" disabled {{ old('id_bicicleta') ? '' : 'selected' }}>Selecciona una bicicleta</option>
                                        @foreach($bicicletas as $bicicleta)
                                            <option value="{{ $bicicleta->id }}" {{ old('id_bicicleta') == $bicicleta->id ? 'selected' : '' }}>
                                                {{ $bicicleta->nombre }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <select id="id_sesion" name="id_sesion" class="form-control @error('id_sesion') is-invalid @enderror" required>
                                        <option value="" disabled {{ old('id_sesion') ? '' : 'selected' }}>Selecciona una sesión</option>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="recorrido" type="text"
                                        ...
                                        value="{{ old('recorrido') }}" placeholder="Ej: Ruta al pueblo">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="potencia_media" type="number"
                                        ...
                                        value="{{ old('potencia_media') }}" min="0">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="potencia_normalizada" type="number"
                                        ...
                                        value="{{ old('potencia_normalizada') }}" min="0">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="velocidad_media" type="number" step="0.01"
                                        ...
                                        value="{{ old('velocidad_media') }}" min="0">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="puntos_estres_tss" type="number" step="0.01"
                                        ...
                                        value="{{ old('puntos_estres_tss') }}" min="0">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="factor_intensidad_if" type="number" step="0.01"
                                        ...
                                        value="{{ old('factor_intensidad_if') }}" min="0">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="ascenso_metros" type="number"
                                        ...
                                        value="{{ old('ascenso_metros') }}" min="0">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <textarea id="comentario"
                                        ...
                                        rows="3"
                                        placeholder="Notas sobre el entrenamiento">{{ old('comentario') }}</textarea>
                            ...
                            <div class="row mb-0">
                                <div class="col-md-6 offset-md-4">
                                    ...
                                    <a href="{{ route('resultados') }}" class="btn btn-secondary">
                                        Cancelar
                                    </a>
                                </div>
                            </div>
