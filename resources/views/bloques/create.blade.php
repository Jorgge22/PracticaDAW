            ...
            <div class="col-md-8">
                <div class="card shadow-sm">
                    ...
                    <div class="card-header bg-success text-white">
                        <h4 class="mb-0">Crear Nuevo Bloque de Entrenamiento</h4>
                    </div>
                        ...
                        <form method="POST" action="{{ route('bloques.store') }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="nombre" type="text"
                                        ...
                                        value="{{ old('nombre') }}" placeholder="Ej: Calentamiento" autocomplete="off"
                                        required>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <textarea id="descripcion"
                                        ...
                                        rows="3"
                                        placeholder="Descripción del bloque">{{ old('descripcion') }}</textarea>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="tipo" type="text"
                                        ...
                                        value="{{ old('tipo') }}" placeholder="Ej: Resistencia, Velocidad" autocomplete="off"
                                        required>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="duracion_estimada" type="number"
                                        ...
                                        value="{{ old('duracion_estimada') }}" min="0">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="potencia_pct_min" type="number"
                                        ...
                                        value="{{ old('potencia_pct_min') }}" min="0" max="100">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="potencia_pct_max" type="number"
                                        ...
                                        value="{{ old('potencia_pct_max') }}" min="0" max="100">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="pulso_pct_max" type="number"
                                        ...
                                        value="{{ old('pulso_pct_max') }}" min="0" max="100">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="pulso_reserva_pct" type="number"
                                        ...
                                        value="{{ old('pulso_reserva_pct') }}" min="0" max="100">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <textarea id="comentario"
                                        ...
                                        rows="3"
                                        placeholder="Añade un comentario sobre el bloque">{{ old('comentario') }}</textarea>
                            ...
                            <div class="row mb-0">
                                <div class="col-md-6 offset-md-4">
                                    ...
                                    <a href="{{ route('bloques') }}" class="btn btn-secondary">
                                        Cancelar
                                    </a>
                                </div>
                            </div>
