...
Route::post('/bicicletas', [BicicletasController::class, 'store'])->name('bicicletas.store')->middleware('auth');
Route::get('/bicicletas/{id}', [BicicletasController::class, 'show'])->name('bicicletas.show')->middleware('auth');
Route::get('/bicicletas/{id}/edit', [BicicletasController::class, 'edit'])->name('bicicletas.edit')->middleware('auth');
Route::put('/bicicletas/{id}', [BicicletasController::class, 'update'])->name('bicicletas.update')->middleware('auth');
Route::delete('/bicicletas/{id}',[BicicletasController::class, 'destroy'])->name('bicicletas.destroy')->middleware('auth');
